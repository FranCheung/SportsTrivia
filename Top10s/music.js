// script.js
const top10Items = ["despacito", "see you again", "shape of you", "uptown funk", "gangnam style", "sugar", "counting stars", "roar", "sorry", "thinking out loud"]; // Example category: fruits
let guesses = [];
let score = 0;
