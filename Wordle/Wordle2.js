const correctAnswer = "Dallas Cowboys".toUpperCase(); // Example answer, adjust accordingly
const maxAttempts = 6;
let attempts = 0;
let guesses = [];
const hints = [
    "Known as America's Team.",
    "Players like Troy Aikman, Emmett Smith, and Michael Irvin played for them.",
