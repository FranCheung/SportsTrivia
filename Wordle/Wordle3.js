const correctAnswer = "Wayne Gretzky".toUpperCase(); // Example answer, adjust accordingly
const maxAttempts = 6;
let attempts = 0;
let guesses = [];
const hints = [
    "The NHL's all time leader in goals, assists, and points.",
    "Known as the Great One.",
    "His jersey number 99 is retired by the entire NHL."
];
